...
// --- Supabase Config ---
const SUPABASE_URL = window.CONFIG?.SUPABASE_URL || 'https://ziiwbevepzfibdhkkthk.supabase.co';
const SUPABASE_ANON_KEY = window.CONFIG?.SUPABASE_ANON_KEY || 'sb_publishable_MO-nZfFn3T2XQKZU-FlbXA_zbSe8DNT';
